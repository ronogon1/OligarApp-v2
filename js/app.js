...
function imprimirFacturaSeparada() {
  const factura = document.getElementById('facturaContent');
  ...
  const contenido = factura.innerHTML;
  ...
  ventana.document.write(`
    ...
    <head>
      ...
      <link href="https://fonts.googleapis.com/css2?family=Great+Vibes&family=Poppins:ital,wght@0,400;0,500;0,600;0,700;1,400&display=swap" rel="stylesheet">
      ...
      <style>
        ...
        .factura-item > div:first-child {
          flex: 1;
        }

        .factura-item > div:last-child {
          min-width: 120px;
          text-align: right;
          font-weight: 500;
        }
        ...
        .factura-total-row span:last-child {
          text-align: right;
        }

        .factura-total-row.total-general {
          font-size: 17px;
          font-weight: 700;
          margin-top: 4px;
        }
